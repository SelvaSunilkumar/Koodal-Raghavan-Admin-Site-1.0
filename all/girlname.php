    ...
    <head>
        ...
        <script>
            ...
            function editName() {
                ...
                if (name != '' && edit != '') {
                    if (user == "user") {
                        ...
                        ajax.open("POST","php/editbabygirl.php");
                        ajax.send(formdata);
                    } else {
                        logLoader(user + ">>Edit Girl Baby Name>>Access Denied");
                    }
                }
                else {
            ...
            function deleteName() {
                ...
                if (name != '') {
                    if (user == "user") {
                        ...
                        ajax.open("POST","php/deletebabygirl.php");
                        ajax.send(formdata);
                    } else {
                        logLoader(user + ">>Delete Girl Baby Name>>Access Denied");
                    }
                }
                else {
                    window.alert("Some sort of Details are Missing...");
            ...
            function onCompleteDelete(event) {
                ...
                logLoader(user + ">>Delete Girl Baby name>>" + status);
            }

            function onComplete(event) {
                var status = event.target.responseText;
                _("status").innerHTML = status;
                logLoader(user + ">>Edit Girl Baby Name>>" + status);
            }
        </script>
        <title>Baby Names - Girl</title>
            ...
            <div class="table-responsive">
                <table class="table" id="table">
                    ...
                    <tbody>
                        <?php 
                            if ($connection) {
                                $name_query = "SELECT * FROM girlname";
